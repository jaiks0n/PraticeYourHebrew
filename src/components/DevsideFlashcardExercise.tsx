...
import { DevsideFlipCard } from './DevsideFlipCard'
...
interface DevsideFlashcardExerciseProps {
  cards?: JasonVocabularyEntry[]
  title?: string
}

export function DevsideFlashcardExercise({
  cards: sourceCards = jasonVocabulary,
  title = 'Devside',
}: DevsideFlashcardExerciseProps) {
